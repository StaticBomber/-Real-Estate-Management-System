...
<%! String email,password,name,address,phone,city,state,country,pincode;%>
 <%
      ...
      String sql="SELECT * FROM tenant_data";
      Statement stmt = (Statement) con.createStatement();
      ResultSet rs=stmt.executeQuery(sql);
      while(rs.next())
                    {
        
       if(rs.getString(1).equals(LoginBackend.username))
       {          
...
<div id="fh5co-page">
			...
			<div class="header-inner">
				...
				<nav role="navigation">
					<ul>
						...
						<li><a class="active"  href="tenant_profile.jsp">Profile</a></li>
	...
	<div class="container-contact100">
		...
		<div class="wrap-contact100">
			...
			<form class="contact100-form validate-form" action="update_tenant_profile">
