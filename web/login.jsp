...
<body>
		...
		<div class="container-login100">
			<div class="wrap-login100">
				<div class="login100-pic js-tilt" data-tilt>
					<img src="login_files/images/img-01.png" alt="IMG">
				</div>

                            <form class="login100-form validate-form" method="post" action="LoginBackend">
					...
					<div>
                                            <input type="radio" name="category" value="tenant_data" required>Tenant
                                           <input type="radio" name="category" value="owner_data"> Owner
                                          <input type="radio" name="category" value="admin_data"> Admin
                                               
					</div>

					
					<div class="container-login100-form-btn">
						<button class="login100-form-btn" type="submit" name="LoginBackend">
							Login
						</button>
					</div>
	...
	<script src="login_files/vendor/tilt/tilt.jquery.min.js"></script>
	<script >
		$('.js-tilt').tilt({
			scale: 1.1
		})
